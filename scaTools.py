...
path2pfamseq = '/Volumes/SSD_Alpha/Research/Analysis/Code/SCA/Databases/pfamseq.txt'

# the location of your PDB structures
path2structures = '/Volumes/SSD_Alpha/Research/Analysis/Code/SCA/pySCA/Inputs/'

# paths to pymol and needle (EMBOSS) applictaions
path2pymol = '/Volumes/SSD_Alpha/Applications/SBGrid/sbgrid/i386-mac/pymol/2.3.5_173/MacPyMOL.app/Contents/MacOS/pymol'
